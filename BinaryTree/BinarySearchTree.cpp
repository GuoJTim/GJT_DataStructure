...
template <class T>
BinarySearchTree<T>::BinarySearchTree(const BinarySearchTree<T>& s):BinaryTree<T>(s){
	
}

template <class T>
TreeNode<T>* BinarySearchTree<T>::MINIMUM(TreeNode<T>* node){
	while(node->left != nullptr) node = node->left;
	return node;
}

template <class T>
TreeNode<T>* BinarySearchTree<T>::MAXIMUM(TreeNode<T>* node){
...
template <class T>
void BinarySearchTree<T>::Successor(TreeNode<T>* node){
...
template <class T>
void BinarySearchTree<T>::Predecessor(TreeNode<T>* node){
...
template <class T>
void BinarySearchTree<T>::Insert(TreeNode<T>* z){
	BinaryTree<T>::size++;
...
template <class T>
void BinarySearchTree<T>::Delete(TreeNode<T>* z){
	BinaryTree<T>::size--;
...
Dictionary<K,V>::Dictionary():BinarySearchTree<std::pair<K,V>>(){
	
}

template <class K,class V>
Dictionary<K,V>::Dictionary(const Dictionary<K,V>& s):BinarySearchTree<std::pair<K,V>>(s){
...
void Dictionary<K,V>::Delete(const K& k){
	...
	BinarySearchTree<pair<K,V>>::Delete(element);
}


template <class K,class V>
TreeNode<pair<K,V>>* Dictionary<K,V>::Search(K data){
	return Search(BinarySearchTree<pair<K,V>>::root,data);
}
